...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarButtonFont = [UIFont fontWithName:iz_navBarTitleFontName size:22];                                             // NavBarButtonFont : QMUINavigationButtonTypeNormal 和 UINavigationBar 上的 UIBarButtonItem 的字体
    QMUICMI.navBarButtonFontBold = nil;                                         // NavBarButtonFontBold : QMUINavigationButtonTypeBold 的字体
    QMUICMI.navBarBackgroundImage = [UIImage imageWithColor:UIColorClear];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = UIImage.new;                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
    QMUICMI.navBarBarTintColor = UIColorClear;                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    ...
    QMUICMI.navBarTitleColor = QMUICMI.navBarTintColor;                                             // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = [UIFont fontWithName:iz_navBarTitleFontName size:32];                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarShadowImageColor = QMUICMI.tabBarBackgroundImage.qmui_averageColor;                                       // TabBarShadowImageColor : UITabBar 的 shadowImage 的颜色，会自动创建一张 1px 高的图片
    QMUICMI.tabBarTintColor = UIColorRed;                                              // TabBarTintColor : UITabBar 的 tintColor
